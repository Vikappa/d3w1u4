...
public class Carrello {
    ...
    public Carrello(Cliente clienteAss, Articolo[] listaArticoli){
        this.arrayDiArticoliPerCarrello = listaArticoli;
    ...
    public void pushNelCarrello(Articolo newObg){
        ...
        System.out.println("Articolo aggiunto al carrello, pezzi in magazzino -1");
    }
    ...
    public void eliminaDalCarrello(Articolo articoloDaEliminare) {
        for (int i = 0; i < arrayDiArticoliPerCarrello.length; i++) {
            if (arrayDiArticoliPerCarrello[i].equals(articoloDaEliminare)) {
                ...
                System.out.println("Articolo tolto dal carrello, pezzi in magazzino +1");
